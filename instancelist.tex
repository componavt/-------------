\section{Экземпляры объекта "Страна"}

Построим список всех стран.

\begin{itemize}
    \item Объект: \href{https://www.wikidata.org/wiki/Q6256}{страна (Q6256)},
    \item Свойство: \href{https://www.wikidata.org/wiki/Property:P31}{дата основания (P31)}.
\end{itemize}
...
"+": Примерами аиболее полных и проработанных стран на Викиданных являются:
